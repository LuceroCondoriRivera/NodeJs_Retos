...
mensaje. */
  ...
  socket.write("Hola cliente, tu mensaje ha sodo recibido correctamente");
...
//Creo que debería ir el contador en el on('data')


const PORT = 5000;

server.listen(PORT, () => {
  console.log("El servidor esta escuchando desde el poerto" + PORT);
});
